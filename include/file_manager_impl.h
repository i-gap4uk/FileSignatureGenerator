...
{
  public:
    FileManagerImpl(const std::string & output_file,
     ...
     * types::Result::DATA_IS_READ - another data block has been read.
     * successfully. types::Result::ERROR - in the case when the end of file is
     * reached and was a try to read a data
     * types::Result::END_OF_FILE - the end of file has been reached.
     */
    types::Result
    ReadDataBlock(types::file_manager::DataContainer & data_block) override;
